...
String AzureIoT::generateSas(char *key, String endPointUri)
{
  ...
  return "Authorization: SharedAccessSignature sr=laika-hub.azure-devices.net%2Fdevices%2Fmemg&sig=04fUukAnhUabAEfb9bqCBG39tZ5peH7kGPi8DMmKEYE%3D&se=1524737968";
